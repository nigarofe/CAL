...
# LLM Solution %% fold %%
## a) (a) S é lisa em todo ponto?
- Para que a superfície seja lisa em todo ponto, $\vec r_u$ e $\vec r_v$ devem ser vetores linearmente independentes (LI), ou seja, não paralelos.
...
- Quando $(u,v) = (0,0)$
$$\vec r_u(0,0) = (0,\,0,\,1) \quad \text{e} \quad \vec r_v(0,0) = (0,\,0,\,2) = 2\,\vec r_u(0,0)$$
- Isso mostra que S não é lisa no ponto $(0,0,0) = \vec r(0,0)$ pois $\vec r_u \, || \, \vec r_v$  quando $(u,v) = (0,0)$ 


## b) Determine o plano tangente à S no ponto $P = (1,1,3)$
- Para encontrar o plano tangente à um ponto podemos encontrar o vetor normal à ele.
$$
